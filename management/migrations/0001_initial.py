    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voornaam', models.CharField(max_length=20)),
                ('familienaam', models.CharField(max_length=50)),
                ('geslacht', models.CharField(choices=[('m', 'Man'), ('v', 'Vrouw'), ('x', 'Verkies niet te zeggen')], default='m', max_length=1)),
                ...
                ('rekeningnummer', localflavor.generic.models.IBANField(include_countries=None, max_length=34, use_nordea_extensions=False)),
                ('lidnummer_vbl', models.IntegerField(unique=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('functies', models.ManyToManyField(to='management.Functie')),
                ('moeder_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='moeder', to='management.Ouder')),
                ('vader_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='vader', to='management.Ouder')),
            ],
        ),
    ]
