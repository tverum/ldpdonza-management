...
urlpatterns = [
    ...
    path("ploegen/export_preview/", views.export_ploeg_preview,
         name="exporteer_ploeg_preview"),
    path("ploegen/export", views.exporteer_ploegen, name="exporteer_ploegen"),
    path("ploegen/<int:pk>/select/",
         views.PloegSelectView.as_view(), name='ploeg_select'),
    path("ploegen/<int:pk>/view/", views.PloegView.as_view(), name='ploeg_view'),
    path("ploegen/<int:pk>/export-csv/",
         views.export_ploeg_csv, name='ploeg_export_csv'),
    path("ploegen/<int:pk>/export-xlsx/",
         views.export_ploeg_xlsx, name='ploeg_export_xlsx'),
    path("betalingen/stuur_mail/<int:pk>/",
         views.stuur_mail, name="betalingen_mail"),
    path("betalingen/her_mail/<int:pk>/",
         views.herinnering_mail, name="herinnering_mail"),
    path("betalingen/bevestiging/<int:pk>/",
         views.bevestig_mail, name="bevestig_mail"),
